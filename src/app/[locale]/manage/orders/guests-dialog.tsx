...
import { useGetGuestList } from '@/queries/useGetAccount'
...
export default function GuestsDialog({ onChoose }: { onChoose: (guest: GuestItem) => void }) {
  ...
  const dataQuery = useGetGuestList({fromDate, toDate})
  const data: GetListGuestsResType['data'] = dataQuery.data?.payload.data || []
